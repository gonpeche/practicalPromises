...
function problemA () {
  ...
  // promise version
  promisifiedReadFile('poem-one/stanza-01.txt').then(function poema(resultado) {
...
function problemB () {
  ...
  // promise version
  promisifiedReadFile('poem-one/stanza-02.txt').then(function poema (resultado) {
    console.log('-- B. callback version (stanza two) --');
    blue(resultado)
    return promisifiedReadFile('poem-one/stanza-03.txt')
  }).then(function poema (resultado) {
    console.log('-- B. callback version (stanza three) --');
    blue(resultado)
  })
...
function problemD () {
  ...
  // promise version
  promisifiedReadFile('poem-one/wrong-file-name.txt').then(function poema(resultado) {
    blue(resultado)
...
function problemE () {
  ...
  // promise version
  promisifiedReadFile('poem-one/stanza-03.txt').then(function poema (resultado) {
    console.log('-- E. callback version (stanza three) --');
    blue(resultado)
...
function problemF () {
  ...
  .catch( x=>magenta(x) ).then( () => console.log('done') )
